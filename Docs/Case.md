...
3. Mobil-specifikke funktioner:
    ...
    * QR-kode billet system: Hver gæst får en unik QR-kode, som kan scannes af planlæggeren ved ankomst til eventet. Dette registrerer gæstens ankomst og kan bruges til at holde styr på deltagerne i realtid. (prioritized optional)
